...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Calcular tamaño de ficha dinámicamente
        calculateChipSize()
    ...
    private fun initializeBoard() {
        ...
        for (row in 0 until ROWS) {
            ...
            for (col in 0 until COLS) {
                ...
                val layoutParams = TableRow.LayoutParams(chipSize, chipSize)
                layoutParams.setMargins(2, 2, 2, 2)  // Espaciado entre fichas
